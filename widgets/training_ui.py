...
class Ui_TrainingWidget(object):
    def setupUi(self, TrainingWidget):
        ...
        self.playWidget.setMinimumSize(QtCore.QSize(128, 128))
        ...
        self.lnEpochs = QtWidgets.QLineEdit(self.widget_15)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lnEpochs.sizePolicy().hasHeightForWidth())
        self.lnEpochs.setSizePolicy(sizePolicy)
        self.lnEpochs.setObjectName("lnEpochs")
        self.verticalLayout_16.addWidget(self.lnEpochs)
...
"")
        ...
        self.lossWidget = QtWidgets.QWidget(self.widget_6)
        self.lossWidget.setMinimumSize(QtCore.QSize(550, 350))
        self.lossWidget.setMaximumSize(QtCore.QSize(850, 350))
        self.lossWidget.setStyleSheet("border: 2px solid black")
        self.lossWidget.setObjectName("lossWidget")
        self.lossLayout = QtWidgets.QHBoxLayout(self.lossWidget)
        self.lossLayout.setObjectName("lossLayout")
        self.gridLayout_2.addWidget(self.lossWidget, 1, 1, 1, 2)
        self.confusionMatrixWidget = QtWidgets.QWidget(self.widget_6)
        self.confusionMatrixWidget.setMinimumSize(QtCore.QSize(200, 0))
        self.confusionMatrixWidget.setMaximumSize(QtCore.QSize(350, 16777215))
        self.confusionMatrixWidget.setStyleSheet("border: 2px solid black")
        self.confusionMatrixWidget.setObjectName("confusionMatrixWidget")
        self.confLayout = QtWidgets.QVBoxLayout(self.confusionMatrixWidget)
        self.confLayout.setContentsMargins(0, 0, 0, 0)
        self.confLayout.setSpacing(0)
        self.confLayout.setObjectName("confLayout")
        self.gridLayout_2.addWidget(self.confusionMatrixWidget, 0, 2, 1, 1)
        self.convFilterWidget = QtWidgets.QWidget(self.widget_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.convFilterWidget.sizePolicy().hasHeightForWidth())
        self.convFilterWidget.setSizePolicy(sizePolicy)
        self.convFilterWidget.setStyleSheet("border: 2px solid black")
        self.convFilterWidget.setObjectName("convFilterWidget")
        self.gridLayout_2.addWidget(self.convFilterWidget, 1, 0, 1, 1)
        self.neuralNetworkWidget = QtWidgets.QWidget(self.widget_6)
        self.neuralNetworkWidget.setMinimumSize(QtCore.QSize(0, 300))
        self.neuralNetworkWidget.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.neuralNetworkWidget.setStyleSheet("")
    ...
    def retranslateUi(self, TrainingWidget):
        ...
        self.label_16.setText(_translate("TrainingWidget", "Epochs"))
